        ...
        public async Task<List<ProductDTO>> GetAllProducts()
        {
            try
            {
                ...
                foreach (var product in result) 
                {
                    ...
                    var customProduct = new ProductDTO(product.ProductId,product.ProductName,product.Sku,product.BarCode,product.ProductPrice,product.ProductQuantity,categoryName,product.CategoryId);
